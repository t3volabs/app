<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-200 to-red-200 flex items-center justify-center p-4 sm:p-0">
    <div class="bg-white bg-opacity-40 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col sm:flex-row w-full max-w-6xl h-[calc(100vh-2rem)] sm:h-[90vh]">
      <div v-if="!encryptionKeySet" class="w-full p-6 sm:p-12 text-center flex flex-col justify-center">
        <h1 class="text-3xl sm:text-4xl font-semibold text-gray-800 mb-8">Set Master Password</h1>
      ...
      <div v-else-if="!isUnlocked" class="w-full p-6 sm:p-12 text-center flex flex-col justify-center">
